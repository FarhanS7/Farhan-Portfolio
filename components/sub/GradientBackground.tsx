  ...
  useEffect(() => {
    ...
    const drawGradient = (scrollPosition: number) => {
      ...
      accentGradient.addColorStop(
        0,
        `rgba(${theme.accentColor.join(",")}, 0.05)`
      );
    ...
    const drawStars = () => {
      ...
      stars.forEach((star) => {
        ...
        gradient.addColorStop(
          0,
          `rgba(${isDark ? "255,255,255" : "99,102,241"}, ${opacity})`
        );
    ...
    const drawParticles = () => {
      ...
      particlesRef.current.forEach((particle) => {
        ...
        gradient.addColorStop(
          0,
          `rgba(${theme.accentColor.join(",")}, ${particle.opacity})`
        );
        gradient.addColorStop(1, "rgba(0,0,0,0)");
    ...
    <ThemeContext.Provider value={{ isDark, toggleTheme }}>
      <div
        className={`min-h-screen ${
          isDark ? THEMES.dark.textColor : THEMES.light.textColor
